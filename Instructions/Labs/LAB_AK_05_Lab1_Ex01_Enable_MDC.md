...
1. En la sección *Administración de la posición de seguridad en la nube (CSPM)*, selecciona **Activado** para *Defender CSPM*.

1. En la sección *Protección de cargas de trabajo en la nube (CWP)*, selecciona **Activado** para el *Plan 2 para servidores*.
...
1. Vuelva a la página **Información general** y revisa el mosaico **Posición de seguridad**. Puedes ver tu *Puntuación de seguridad* actual junto con el número de controles y recomendaciones completadas. Al seleccionar este icono, se te redirigirá a una vista de exploración en profundidad entre suscripciones
    ...
    >**Nota:** la puntuación de seguridad y otra información del icono *Posición de seguridad* pueden tardar hasta 24 horas en calcularse. Es posible que no se rellene completamente durante este laboratorio.
